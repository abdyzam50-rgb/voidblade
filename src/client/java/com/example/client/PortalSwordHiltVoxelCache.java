...
/** Hilt voxel bake for 16×16 sword sprites. */
final class PortalSwordHiltVoxelCache {
    ...
    private PortalSwordHiltVoxelCache() {}
    ...
    private static void buildFlatElements(TextureData data, List<BlockElement> baseElements, List<BlockElement> foilElements) {
        ...
        for (int row = 0; row < data.height; row++) {
            for (int col = 0; col < data.width; col++) {
                ...
                BlockElementFace.UVs pixelUv = new BlockElementFace.UVs(col, row, col + 1, row + 1);
